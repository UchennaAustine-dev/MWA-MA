...
import { setNewUserId } from "@/redux/slices/userSlice";
import { useRouter } from "expo-router";
import React, { useState } from "react";
import {
  Alert,
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    flexGrow: 1,
    justifyContent: "center", // center vertically when keyboard hidden
  ...
  container: {
    ...
    maxWidth: 400,
    backgroundColor: "#fff",
    // Optional: remove borderRadius if you want sharp edges
    // borderRadius: 24,
    paddingVertical: 32,
    paddingHorizontal: 20,
    alignItems: "center",
